...
Per ulteriori informazioni, visita il link:https://www.openshift.com["Sito web di Red Hat OpenShift"^].
...
Per ulteriori informazioni, visita il link:https://www.netapp.com["Sito web NetApp"^].
...
NetApp Trident è un orchestratore di storage open-source e completamente supportato per container e distribuzioni Kubernetes come {k8s_distribution_name}. Per ulteriori informazioni, visita il link:https://docs.netapp.com/us-en/trident/index.html["Documentazione Trident"^].
...
Una matrice di supporto per la versione di Trident testata con ciascuna distribuzione di Kubernetes è disponibile in link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["Frontend supportati (orchestratori)"^].
