...
Per ulteriori informazioni sulle piattaforme NetApp AFF e FAS, consulta il link:https://docs.netapp.com/platstor/index.jsp["NetApp documentazione della piattaforma hardware"^].
