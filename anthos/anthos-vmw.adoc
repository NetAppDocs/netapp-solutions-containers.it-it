...
Per configurare i gruppi di affinità, consultare il collegamento appropriato qui sotto per la propria versione di VMware vSphere.

* link:https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-resource-management/using-drs-clusters-to-manage-resources/using-vm-host-affinity-rules.html["Documentazione di vSphere 9.0: utilizzo delle regole di affinità DRS"^]
* link:https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/7-0/vsphere-resource-management/using-drs-clusters-to-manage-resources/using-vm-host-affinity-rules.html["vSphere 7.0 Documentazione: Utilizzo delle regole di affinità DRS"^]
