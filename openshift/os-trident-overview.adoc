...
Consulta la link:https://docs.netapp.com/us-en/trident/index.html["Documentazione del prodotto Trident"^] per i dettagli relativi all'installazione e alla configurazione.
...
. Scarica l'archivio di installazione sulla workstation dell'amministratore ed estrai il contenuto. La versione corrente di Trident può essere scaricata da link:https://github.com/NetApp/trident/releases?q=25.&expanded=true["Pagina delle release di Trident su GitHub"^].
