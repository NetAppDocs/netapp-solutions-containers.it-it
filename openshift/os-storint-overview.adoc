...
[role="lead"]
Scopri NetApp Trident Protect, che è stato convalidato per la gestione delle applicazioni e dello storage persistente per la soluzione OpenShift Virtualization.

Trident, un provider e orchestratore di storage open source gestito da NetApp, insieme al suo componente aggiuntivo, NetApp Trident Protect, offre soluzioni robuste per orchestrare e gestire dati persistenti in ambienti basati su container come Red Hat OpenShift.
...
* link:https://docs.netapp.com/us-en/trident/trident-protect/learn-about-trident-protect.html["Documentazione Trident Protect"]
