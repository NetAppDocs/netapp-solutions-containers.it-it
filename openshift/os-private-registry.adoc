...
[role="lead"]
Per la maggior parte delle implementazioni di Red Hat OpenShift, l'utilizzo di un registro pubblico come link:https://quay.io["Quay.io"^] o link:https://hub.docker.com["DockerHub"^] soddisfa le esigenze della maggior parte dei clienti. Tuttavia ci sono momenti in cui un cliente potrebbe voler ospitare le proprie immagini private o personalizzate.
