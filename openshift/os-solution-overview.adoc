...
Le versioni elencate in questa matrice sono quelle rispetto alle quali la soluzione è stata validata al momento della pubblicazione di questa documentazione.
...
|===
Ulteriori funzionalità vengono continuamente testate con le versioni più recenti di ONTAP, NetApp Trident e Red Hat OpenShift supportate da Trident. Per la versione più recente di OpenShift supportata da Trident, visita il link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["Documentazione Trident"^].
