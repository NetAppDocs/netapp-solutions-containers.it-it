...
. Segui le istruzioni link:https://docs.openshift.com/container-platform/4.7/installing/index.html["istruzioni di installazione"^] fornite da Red Hat per effettuare la distribuzione nell'ambiente di tua scelta.
...
* link:os-on-bm.html["OpenShift su Bare Metal"]
* link:os-on-openstack.html["OpenShift sulla piattaforma Red Hat OpenStack"]
* link:os-on-rhv.html["OpenShift su Red Hat Virtualization"]
* link:os-on-vmw.html["OpenShift su VMware vSphere"]
