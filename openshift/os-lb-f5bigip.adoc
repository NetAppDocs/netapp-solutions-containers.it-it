...
. Installa l'estensione F5 Application Services 3 per consentire ai sistemi BIG-IP di accettare configurazioni in formato JSON anziché tramite comandi imperativi. Vai a link:https://github.com/F5Networks/f5-appsvcs-extension/releases["Repository GitHub F5 AS3"^] e scarica il file RPM più recente.
